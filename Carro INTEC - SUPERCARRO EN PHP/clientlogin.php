...
?>
    ...
    <head>
        <title> Empleados Login | Carro Intec </title>
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
                                    <ul class="dropdown-menu">
                                        <li> <a href="entercar.php">Agregar Carro</a></li>
        ...
        <div class="container">
            <div class="jumbotron">
                <h1 class="text-center">Carros Intec </span>
                </h1>
                <br>
                <p class="text-center">inicia sesion para continuar.</p>
            </div>
        </div>
        ...
        <div class="container" style="margin-top: -2%; margin-bottom: 2%;">
            <div class="col-md-5 col-md-offset-4">
                ...
                <label class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                            ...
                            <label style="margin-left: 5px;"><a href="clientsignup.php">Crear cuenta.</a></label>
                        </form>
                    </div>
                </div>
            </div>
